...
"3. And return true if both statements are true" " == just mean equal too" " '>' is greater than"

"6. Information can be passed to methods as parameter. Parameters act as variables inside the method , an a argument pass data through "

"8. fuction is how code is ran/processed and without your code wouldnt be ran"
